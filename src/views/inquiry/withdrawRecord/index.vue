...
<script lang="ts" setup>
  ...
  import { columns, userLevelMap, withdrawTypeMap, withdrawStatusMap } from './columns';
  import { getWithdrawRecordList } from '@/api/inquiry/withdrawRecord';
  ...
  const loadDataTable = async (res: any) => {
    return await getWithdrawRecordList({ ...getFieldsValue(), ...res });
  };
